                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2"><#Adm_System_webs#></th>
                                        </tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_https_certs" style="display:none">
                                        <tr>
                                            <th colspan="4"><#Adm_System_https_certs#></th>
                                        </tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2"><#Adm_System_term#></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_wins" style="display:none">
                                        <tr>
                                            <th colspan="2">Windows Internet Name Service (WINS)</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" id="tbl_ttyd" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="2"><#Adm_Svc_ttyd_setup#></th>
                                        </tr>
                                        <tr id="div_ttyd">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2"><#Adm_System_misc#></th>
                                        </tr>
