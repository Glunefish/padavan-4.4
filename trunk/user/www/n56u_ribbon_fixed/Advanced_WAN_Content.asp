                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_dhcp_sect">
                                        <tr>
                                            <th id="dhcp_sect_desc" colspan="2"><#IPConnection_ExternalIPAddress_sectionname#></th>
                                        </tr>
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2"><#IPConnection_x_DNSServerEnable_sectionname#></th>
                                        </tr>
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_vpn_control">
                                        <tr>
                                            <th colspan="2"><#PPPConnection_UserName_sectionname#></th>
                                        </tr>
				...
				<td>
					...
					<tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2"><#PPPConnection_x_HostNameForISP_sectionname#></th>
                                        </tr>
                                        <tr id="row_auth_type">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_viptv_sect" style="display:none">
                                        <tr>
                                            <th colspan="2"><#MAN_VIPTV_desc#></th>
                                        </tr>
                                        <tr>
